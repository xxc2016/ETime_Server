...
public class User {
     ...
     final public static  int  IMAGE_STORE_REQUEST = 0x00007;//用户头像上传请求
     final public static  int  IMAGE_STORE_RESPONSE_SUCCESSED = 0x00008;//用户头像上传成功
     final public static  int  IMAGE_STORE_RESPONSE_FAILED =0x00009;//用户头像上传失败
